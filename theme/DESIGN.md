...
| Chiasmus | Time (Trigger tab over Division menu over Time dial; Pre/Drift and Sens/Freeze columns) · Direction (Pattern tab over Flip; Pitch over Fine) · Shape (grain display + envelope well over Smooth/Swell and readouts) · Loop (Feedback/Cross/Diffuse over Tone/Drive) · Output (Width/Duck over Dry/Wet/Output). All full-size dials. Width 846. |
