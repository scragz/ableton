...
var PERCENT = { drift: 'drift', sens: 'sens', flip: 'flip', smooth: 'smooth', swell: 'swell', feedback: 'feedback',
    cross: 'crossamt', tone: 'tone', drive: 'drive', diffuse: 'diffuse', width: 'width', duck: 'duck', mix: 'drywet' };
...
// Time is ignored in Sync, Division outside Sync, Sens outside Onset.
function dimming() {
...
function panel() {
    outlet(1, 'shape', state.smooth / 100, state.swell / 100);
